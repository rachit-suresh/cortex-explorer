    ...
    <div className="flex flex-col items-center justify-center min-h-[80vh] text-center">
      ...
      >
        ...
        <p className="text-xl md:text-2xl text-black font-bold mb-12 max-w-2xl mx-auto bg-white border-2 border-black p-4 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
          Visualize your interests, discover new passions, and connect the dots
          in a mind-bending interactive graph.
        </p>
        ...
        {[
          {
            ...
            desc: "AI-powered grouping of your related interests.",
            color: "bg-[#fb7185]",
          },
          {
            icon: Zap,
            title: "Instant Discovery",
            desc: "Get personalized recommendations in seconds.",
            color: "bg-[#facc15]",
          },
          {
            icon: Share2,
            title: "Deep Hierarchy",
            desc: "Drill down from Sports to F1 to Drivers.",
            color: "bg-[#22d3ee]",
          },
        ].map((feature, idx) => (
          <motion.div
